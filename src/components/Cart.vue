<template>
    <div class="offcanvas offcanvas-end cart-canvas" tabindex="-1" id="cartCanvas">
        ...
        <div class="offcanvas-body p-3">
            ...
            <!-- Address info - HTML corrigido -->
            <div class="d-flex align-items-center justify-content-between mb-3 rounded my-2">
                <div class="contorno p-2 d-flex align-items-start justify-content-between rounded-3 w-100">
                    ...
                    <div class="d-flex align-items-start w-100">
                        ...
                        <div class="text-content flex-grow-1">
                            <div class="d-flex justify-content-between align-items-start">
                                ...
                                <div class="d-flex align-items-center justify-content-center gap-2">
                                    ...
                                    >
                                        ...
                                        <i v-else class="bi bi-pencil-square fs-5 text-secondary"></i>
                                    </button>
                                    <svg v-if="selectedAddress" width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div v-else class="d-flex text-muted small mt-2">
                                <p class="mb-0">Selecione o tipo de entrega</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<script setup>
    ...
    const handleAddressSelected = (address) => {
        ...
        toast.success(`Endereço selecionado: ${address.nickname || formatAddress(address)}`, {
            timeout: 3000
        })
    }
